...
$fileMutiply = 1000;
    ...
    $id_db.class.php = $db->query("SELECT tb_Cards.COL_PRIMARY_KEY as 'Log ID',$tbHRD.COL_CALL as 'Call',"
        . "tb_Cards.COL_File_Path_E as 'Card' FROM HRD_Web.tb_Cards INNER JOIN $dbnameHRD.$tbHRD ON "
        . "tb_Cards.COL_PRIMARY_KEY = $tbHRD.COL_PRIMARY_KEY WHERE tb_Cards.COL_File_Path_E <> ''");
