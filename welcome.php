...
<html> 
    ...
    <form enctype="multipart/form-data" class="Txt_upload" method='POST'  action='welcome.php'>
            <label for="file">Enter upload here Awards:            </label>
            <input type='file' name='file'/><br><br>
			
			<label for="filecard">Enter upload here Paper Card:     </label>
            <input type='file' name='filecard'/><br><br>
			
			<label for="fileback">Enter upload here Paper Card Back:</label>
